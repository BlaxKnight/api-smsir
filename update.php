...
<body>
  <main>
    <div class="form-wrapper">
      <form class="form" action="process/sms_update.php" method="post">
        <fieldset class="fieldset">
          ...
          <legend class="fieldset-legend">
            <h2 class="legend-title">Edit Record</h2>
          </legend>
          ...
          <div class=" input-group">
            ...
            <textarea
              class="input-group-el"
              name="api-key"
              id="api-key"><?php echo $pass ?></textarea>
          </div>
          <div class="input-group">
            ...
            <textarea
              ...
              id="message"
              minlength="1"
              maxlength="1000"><?php echo $msg ?></textarea>
          </div>
